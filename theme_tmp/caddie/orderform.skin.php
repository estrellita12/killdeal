...
// 2024-01-23
if($_SERVER['REMOTE_ADDR']=="58.231.24.148" && $dev_flag){ // if($default['de_easy_pay_use'])
    $default['de_easy_pay_services'] = "naverpay,kakaopay,tosspay";
    $de_easy_pay_service_array = explode(",",$default['de_easy_pay_services']);
    echo '<input type="hidden" name="easy_pay_service" value="">'.PHP_EOL;
    if( in_array('naverpay', $de_easy_pay_service_array) ){
        echo '<input type="radio" name="paymethod" id="easy_naverpay" value="간편결제" onclick="calculate_paymethod(this.value);"><label for="easy_naverpay" >네이버페이</label>'.PHP_EOL;
    }
    if( in_array('kakaopay', $de_easy_pay_service_array) ){
        echo '<input type="radio" name="paymethod" id="easy_kakaopay" value="간편결제" onclick="calculate_paymethod(this.value);"><label for="easy_kakaopay" >카카오페이</label>'.PHP_EOL;
    }
    if( in_array('tosspay', $de_easy_pay_service_array) ){
        echo '<input type="radio" name="paymethod" id="easy_tosspay" value="간편결제" onclick="calculate_paymethod(this.value);"><label for="easy_tosspay" >토스페이</label>'.PHP_EOL;
    }
...
// 2024-01-23
<?php if($_SERVER['REMOTE_ADDR']=="58.231.24.148"){ // // if($default['de_easy_pay_use']) ?>
