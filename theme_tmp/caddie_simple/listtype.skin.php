...
<?php } else { ?>
	...
	for($i=0; $i<$list_count; $i++) {
		...
		$cat_str .= '<li '.$active.'><a href="'.$cat_sort_href.'"><span>'.trim($list_best[$i]['subj']).'</span></a></li>'.PHP_EOL;
	}
	//echo $cat_sort_href;

	 ?>
	<div class="tab_sort_box tab_sort_box2">
		<ul class="bestca_tab1 cateDesc">
...
<div class="pr_desc sub_pr_desc wli4 <?php if($type== '2') { echo 'sub_best_desc';}?>">
	<ul>
	<?php
	for($i=0; $row=sql_fetch_array($result); $i++) {
		if($type == '2' && $i > 11) break;
