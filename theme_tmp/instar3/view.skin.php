        ...
        <div class="vi_txt_bx">
            ...
            <div class="price_bx">
                ...
                <dl>
                    ...
                    <dd class="price tl"><?php echo display_price2(ceil(($gs['goods_price']/0.9)/100)*100); ?></dd>
                </dl>
                <dl>
                    <dt class="padt5">할인 코드</dt>
                    <dd class=""><?php echo trans_pt_name($pt_id) ?></dd>
                </dl>
                <dl>
                    <dt class="padt5">최종 할인 가격</dt>
