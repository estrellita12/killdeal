					...
					<tr>
						...
						<td class="vat tal">
							...
							<p class="padt3">
								...
								<a href="<?php echo TB_SHOP_URL; ?>/orderchange.php?gs_id=<?php echo $od['gs_id']; ?>&od_id=<?php echo $od['od_id']; ?>&q=반품" onclick="win_open(this, 'winorderreturn', '650', '530','yes');return false;" class="btn_ssmall bx-white">반품신청</a>
								<a href="<?php echo TB_SHOP_URL; ?>/orderchange.php?gs_id=<?php echo $od['gs_id']; ?>&od_id=<?php echo $od['od_id']; ?>&q=교환" onclick="win_open(this, 'winorderchange', '650', '530','yes');return false;" class="btn_ssmall bx-white">교환신청</a>
								<?php } ?>
								<a href="<?php echo TB_SHOP_URL; ?>/orderreview.php?gs_id=<?php echo $od['gs_id']; ?>&od_id=<?php echo $od['od_id']; ?>" onclick="win_open(this, 'winorderreview', '650', '530','yes');return false;" class="btn_ssmall bx-white">구매후기 작성</a>
							</p>
							<?php } ?>
						</td>
					</tr>
