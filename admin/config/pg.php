...
<div class="tbl_frm01">
    ...
    <tr>
        ...
        <td>
            <input type="checkbox" name="de_easy_pay_services[]" value="naverpay" id="de_easy_pay_use" <?php echo strpos($default['de_easy_pay_services'],"naverpay")!==false?"checked":"" ?>>            <label for="easy_pay_naver">네이버페이</label>
            <input type="checkbox" name="de_easy_pay_services[]" value="kakaopay" id="easy_pay_kakao" <?php echo strpos($default['de_easy_pay_services'],"kakaopay")!==false?"checked":"" ?>>
            <label for="easy_pay_kakao">카카오페이</label>
            <input type="checkbox" name="de_easy_pay_services[]" value="tosspay" id="easy_pay_toss" <?php echo strpos($default['de_easy_pay_services'],"tosspay")!==false?"checked":"" ?>>
            <label for="easy_pay_toss">토스페이</label>
            <input type="checkbox" name="de_easy_pay_services[]" value="applepay" id="easy_pay_apple" <?php echo strpos($default['de_easy_pay_services'],"applepay")!==false?"checked":"" ?>>
