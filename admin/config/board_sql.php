...
"CREATE TABLE IF NOT EXISTS `shop_board_{$bo_table}` (
  ...
  `fileurl1` varchar(200) NOT NULL COMMENT '파일첨부1',
  `fileurl2` varchar(200) NOT NULL COMMENT '파일첨부2',
  ...
  `main_use` tinyint(4) NOT NULL default 0 COMMENT '메인노출',
  `main_order` int(11) NOT NULL default 0 COMMENT '메인순서',
