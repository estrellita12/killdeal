...
<div class="tbl_frm01">
	...
	<tr>
		...
		<td>
			<select name="sfl">
				<?php echo option_selected('id', $sfl, '가맹점ID'); ?>
				<?php echo option_selected('name', $sfl, '가맹점명'); ?>
			</select>
	...
	<tr>
		<th scope="row">만료일</th>
		<td>
            <input type="hidden" name="spt" value="term_date">
...
<div class="tbl_head02">
	...
	<tr>
		...
		<th scope="col" rowspan="2"><?php echo subject_sort_link('name',$q2); ?>가맹점명</a></th>
		<th scope="col" rowspan="2"><?php echo subject_sort_link('id',$q2); ?>가맹점 아이디</a></th>
