...
<form name="fregform" method="post" action="./partner/pt_ppopup_form_update.php" onsubmit="return fregform_submit(this);">
...
<div class="btn_confirm">
	...
	<a href="./partner.php?code=ppopup_list&mb_id=<?php echo $mb_id; ?>&page=<?php echo $page; ?>" class="btn_large bx-white">목록</a>
</div>
</form>
