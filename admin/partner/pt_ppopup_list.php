...
// 테이블의 전체 레코드수만 얻음
$total_count = sel_count("shop_popup",$sql_search);
...
<a href="./partner.php?code=ppopup_form$qstr&page=$page" class="fr btn_lsmall red"><i class="ionicons ion-android-add"></i> 추가하기</a>
EOF;
?>
...
<form name="fpopuplist" id="fpopuplist" method="post" action="./partner/pt_ppopup_list_update.php" onsubmit="return fpopuplist_submit(this);">
...
<div class="tbl_head01">
	...
	for($i=0; $row=sql_fetch_array($result); $i++) {		
		...
		$s_upd = "<a href='./partner.php?code=ppopup_form&w=u&pp_id=$pp_id$qstr&page=$page' class=\"btn_small\">수정</a>";
