...
include_once(TB_ADMIN_PATH.'/member/member_get.inc.php');
...
$btn_frmline = <<<EOF
<a href="./member.php?code=mail_list" class="btn_lsmall bx-white" title="회원 일괄메일발송">전체메일발송</a>
<a href="./sms/sms_member.php" onclick="win_open(this,'pop_sms','245','360','no');return false" class="btn_lsmall bx-white" title="환경설정-SMS기본설정에서 설정 가능">전체문자발송</a>
<a href="./member/member_list_excel.php?$q1" class="btn_lsmall bx-white"><i class="fa fa-file-excel-o"></i> 검색결과 엑셀저장</a>
	...
	<tr>
		...
		<td>
			<select name="sfl">
				...
				<?php //echo option_selected('q_pt_id', $sfl, '추천인'); ?>
				<?php echo option_selected('cellphone', $sfl, '핸드폰'); ?>
				<?php echo option_selected('email', $sfl, '이메일'); ?>
...
<div class="tbl_head01">
	...
	<tr class="<?php echo $bg; ?>">
		...
		<td class="tal"><?php echo get_sideview($row['id'], $row['id']); ?></td>
		<td><?php echo get_grade($row['grade']); ?></td>
		<td class="tal"><?php echo trans_pt_name($row['pt_id']); ?></td>
