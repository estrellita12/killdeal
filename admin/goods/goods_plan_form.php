...
<form name="fregform" method="post" action="./goods/goods_plan_form_update.php" onsubmit="return fboardform_submit(this);" enctype="MULTIPART/FORM-DATA">
...
<div class="tbl_frm02">
	...
	<!-- <tr>
		...
		<td>
			<a href="<?php echo TB_LIB_URL; ?>/Excel/planexcel.xls" class="btn_small bx-blue"><i class="fa fa-download"></i> 샘플파일 다운로드</a>
			<br><br>
			<p>ㆍ엑셀자료는 1회 업로드당 최대 1,000건까지 이므로 1,000건씩 나누어 업로드 하시기 바랍니다.<br>
					ㆍ엑셀파일을 저장하실 때는 Excel 97 - 2003 통합문서 (*.xls)로 저장하셔야 합니다.<br>
					ㆍ엑셀데이터는 4번째 라인부터 저장되므로 샘플파일 설명글과 타이틀은 지우시면 안됩니다.
			</p>
		</td>
	</tr>
	<tr>
		<th scope="row">관련상품코드<br>파일 업로드</th>
	...
	<tr>
		...
		<td>
			...
			<!-- <textarea name="pl_memo" class="frm_input wfull" style="height:350px;resize:none;"><?php echo $pl['pl_memo']; ?></textarea> -->
		</td>
	</tr>
	<tr>
