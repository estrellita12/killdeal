...
<div class="tbl_frm02">
	...
	<tr>
		<th scope="row">성명</th>
		<td><input type="text" name="iq_name" value="<?php echo $iq['iq_name']; ?>" class="frm_input" size="20"><span style="color:#888;margin-left:3px;">(<?php echo $iq['mb_id']; ?>)</span></td>
	</tr>
	<tr>
		<th scope="row">이메일</th>
