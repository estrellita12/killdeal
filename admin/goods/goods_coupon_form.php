...
if($w == "") {
	$coupon['cp_use']			= 1; // 쿠폰사용가능여부 0:불가능 1:사용가능
	$coupon['cp_download']		= 0; // 쿠폰다운로드 제한
	$coupon['cp_overlap']		= 0; // 쿠폰 중복발급가능 여부
	$coupon['cp_sale_type']		= 0; // 할인유형
	$coupon['cp_dups']			= 0; // 중복사용 여부
	$coupon['cp_sale_percent']	= 0; // 할인률
	$coupon['cp_sale_amt_max']	= 0; // 최대 할인금액
	$coupon['cp_sale_amt']		= 0; // 할인금액
	$coupon['cp_inv_type']		= 0; // 유효기간 유형
	$coupon['cp_low_amt']		= 0; // 금액제한
