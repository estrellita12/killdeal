...
$use_aff = 1;
$shop_state = 0;
include_once(TB_ADMIN_PATH.'/goods/goods_query.php');

$btn_frmline = <<<EOF
<input type="submit" name="act_button" value="선택삭제" class="btn_lsmall bx-white" onclick="document.pressed=this.value">
<input type="submit" name="act_button" value="선택상품진열" class="btn_lsmall bx-white" onclick="document.pressed=this.value">
<input type="submit" name="act_button" value="선택상품중지" class="btn_lsmall bx-white" onclick="document.pressed=this.value">
<a href="#" id="frmGoodsExcel" class="btn_lsmall white"><i class="fa fa-file-excel-o"></i> 선택 엑셀저장</a>
<a href="./goods/goods_list_excel.php?$q1" class="btn_lsmall bx-white"><i class="fa fa-file-excel-o"></i> 검색결과 엑셀저장</a>
...
<div class="tbl_head02">
	...
	<tr>
        ...
        <th scope="col" colspan="3" class="th_bg2">판매통계</th>
	...
	<tr class="rows">
        ...
        <th scope="col" class="th_bg2"><?php echo subject_sort_link('readcount',$q2); ?>조회수</a></th>
        <th scope="col" class="th_bg2"><?php echo subject_sort_link('sum_qty',$q2); ?>판매수량</a></th>
        <th scope="col" class="th_bg2"><?php echo subject_sort_link('sum_price',$q2); ?>판매총액</a></th>
	</tr>
	</thead>
	<tbody>
	<?php
	...
	<tr class="<?php echo $bg; ?>">
        ...
        <td rowspan="2" class="tar"><?php echo number_format($row['readcount']); ?></td>
        <td rowspan="2" class="tar"><?php echo number_format($row['sum_qty']); ?></td>
        <td rowspan="2" class="tar"><?php echo number_format($row['sum_price']); ?></td>
...
$(function(){
    ...
    $("#frmGoodsExcel").on("click", function() {
        ...
        if(gs_id == "") {
            ...
            this.href = "./goods/goods_excel2.php?gs_id="+gs_id;
            return true;
        }
    });
