...
<a href="./goods/goods_sabangnet_excel.php?$q1" class="btn_lsmall bx-white"><i class="fa fa-file-excel-o"></i> 검색결과 엑셀저장</a>
EOF;
?>
...
$(function(){
    ...
    $("#frmGoodsExcel").on("click", function() {
        ...
        if(gs_id == "") {
            ...
            this.href = "./goods/goods_sabangnet_excel2.php?gs_id="+gs_id;
            return true;
        }
    });
