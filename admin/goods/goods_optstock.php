...
//$sql_search  = " where b.shop_state = 0 and b.use_aff = 0 and a.io_use = 1 and a.io_noti_qty <> '999999999' and a.io_stock_qty <= a.io_noti_qty ";
$sql_search  = " where b.shop_state = 0 and b.use_aff = 0 and a.io_use = 1 and a.io_noti_qty <> '999999999' and a.io_stock_qty <= 1 ";
