...
$excel->setActiveSheetIndex(0)
	...
	->setCellValue($char++.'1', '구매확정일')
	->setCellValue($char++.'1', '취소일')
...
//		->setCellValueExplicit($char++.$i, $row['od_time'], PHPExcel_Cell_DataType::TYPE_STRING)
    ->setCellValueExplicit($char++.$i, $row['invoice_date'], PHPExcel_Cell_DataType::TYPE_STRING)

		->setCellValueExplicit($char++.$i, $row['user_date'], PHPExcel_Cell_DataType::TYPE_STRING)
		->setCellValueExplicit($char++.$i, $row['cancel_date'], PHPExcel_Cell_DataType::TYPE_STRING)
    ...
    $excel -> getActiveSheet()->getStyle("J$i:Q$i") -> getNumberFormat() -> setFormatCode("#,##0");
	}
    ...
    $excel->getActiveSheet()->getStyle("A1:AR1")->applyFromArray($TD_COLOR);
    ...
    $excel->getActiveSheet()->getColumnDimension('H')->setWidth(57);
    $excel->getActiveSheet()->getColumnDimension('I')->setWidth(28);
    $excel->getActiveSheet()->getColumnDimension('W')->setWidth(15);
    $excel->getActiveSheet()->getColumnDimension('Y')->setWidth(27);
