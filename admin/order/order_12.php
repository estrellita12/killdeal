	...
	<tr>
		...
		<td>
			<select name="sel_field">
				...
				<?php echo option_selected('change_date2', $sel_field, "교환신청일"); ?>
			</select>
...
<div class="tbl_head01">
	...
	<tr>
		<th scope="col">번호</th>
		<th scope="col" class="lh4">주문일시<br><span class="fc_00f">(교환신청일)</span></th>
	...
	<tr class="<?php echo $bg; ?>">
		...
		<td rowspan="<?php echo $rowspan; ?>">
			...
			<span class="fc_00f"><?php echo substr($row['change_date2'],2,14); ?></span>
...
<div class="tbl_frm01">
	...
	<tr>
		<td>
			...
			<input type="submit" name="act_button" value="교환신청철회" class="btn_medium white" onclick="document.pressed=this.value">
		</td>
	</tr>
	</tbody>
	</table>
...
<div class="information">
	...
	<div class="content">
		...
		<div class="desc01 accent">
			...
			<p>ㆍ교환신청 상태의 주문은 "교환중" 상태로만 변경할 수 있으며, 주문의 일부 상품만 부분적으로 "교환중" 상태로 변경 가능합니다.</p>
		</div>
	 </div>
</div>
