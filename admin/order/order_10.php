	...
	<tr>
		...
		<td>
			<select name="sel_field">
				...
				<?php echo option_selected('return_date2', $sel_field, "반품신청일"); ?>
			</select>
...
<div class="tbl_head01">
	...
	<tr>
		<th scope="col">번호</th>
		<th scope="col" class="lh4">주문일시<br><span class="fc_00f">(반품신청일)</span></th>
	...
	<tr class="<?php echo $bg; ?>">
		...
		<td rowspan="<?php echo $rowspan; ?>">
			<?php echo substr($row['od_time'],2,14); ?><br>
			<span class="fc_00f"><?php echo substr($row['return_date2'],2,14); ?></span>
		...
		<td class="td_itname">
            <a href="<?php echo TB_ADMIN_URL; ?>/goods.php?code=form&w=u&gs_id=<?php echo $row2['gs_id']; ?>" target="_blank"><?php echo get_text($gs['gname']); ?></a><br>
            <div class="dn" style="padding: 10px 0 5px;background-color:rgb(253, 251, 245)"><strong>(반품/교환 사유) </strong><?php echo conv_content($row['change_memo'], 0); ?></div>
        </td>
...
<div class="tbl_frm01">
	...
	<tr>
		<td>
			...
			<input type="submit" name="act_button" value="반품신청철회" class="btn_medium white" onclick="document.pressed=this.value">
		</td>
	</tr>
	</tbody>
	</table>
...
<div class="information">
	...
	<div class="content">
		...
		<div class="desc01 accent">
			...
			<p>ㆍ반품신청 상태의 주문은 "반품중" 상태로만 변경할 수 있으며, 주문의 일부 상품만 부분적으로 "반품중" 상태로 변경 가능합니다.</p>
		</div>
	 </div>
</div>
