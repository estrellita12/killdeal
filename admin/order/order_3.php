...
<div class="tbl_head01">
	...
	<tr class="<?php echo $bg; ?>">
		...
		<td class="td_chk">
		    ...
		    <!-- 현대리바트 주문상태 변경호출 상품코드_20200407 -->
			<input type="hidden" name="od_id2[<?php echo $i; ?>]" value="<?php echo $row['od_id']; ?>">
			<input type="hidden" name="item_cd2[<?php echo $i; ?>]" value="<?php echo $row2['gs_id']; ?>"> 
			<input type="hidden" name="pt_id2[<?php echo $i; ?>]" value="<?php echo $row['pt_id']; ?>">
			<!-- end -->
