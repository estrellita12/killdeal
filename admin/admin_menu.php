...
define('ADMIN_MENU2_17',	'가맹점 배너 목록'); // (2021-02-15) 추가
define('ADMIN_MENU2_18',	'가맹점 기획전 목록'); // (2021-02-15) 추가
define('ADMIN_MENU2_19',	'가맹점 팝업 목록'); // (2021-02-15) 추가
...
define('ADMIN_MENU2_12',	'가맹점 정산 리스트');
define('ADMIN_MENU2_14',	'가맹점 상품별 판매 통계');
define('ADMIN_MENU2_15',	'가맹점별 매출');
define('ADMIN_MENU2_16',	'가맹점별 매출(ver2)');
...
define('ADMIN_MENU5_29',    '타임세일 진열관리');
...
define('ADMIN_MENU5_30',    '직송업체 상품관리'); // 2021-01-05
define('ADMIN_MENU5_25',	'상품 검색어관리');
define('ADMIN_MENU5_26',	'상품 검색어순위');
define('ADMIN_MENU5_27',	'가맹점 대기상품'); // (2021-03-03)
define('ADMIN_MENU5_28',	'가맹점 보류상품'); // (2021-03-03)
define('ADMIN_MENU5_31',	'가격정책시트★'); // 2024-02-07
define('ADMIN_MENU5_32',	'상품 후기관리v2'); // 2024-02-15
...
define('ADMIN_MENU6_17',	'주문정산');
define('ADMIN_MENU6_18',	'주문서 생성');
// 통계분석
...
define('ADMIN_MENU8_05',	'이벤트 참여 현황');
...
define('ADMIN_MENU9_05',	'메뉴 관리');
define('ADMIN_MENU9_06',	'메인 진열관리');
define('ADMIN_MENU9_07',	'팝업 관리');
define('ADMIN_MENU9_29',	'푸시 관리(개발중)');
