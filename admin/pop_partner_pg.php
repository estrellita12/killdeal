...
<form name="fmemberform" method="post" action="./pop_partner_pg_update.php">
    ...
    <div id="memberform_pop" class="new_win">
        ...
        <section class="new_win_desc marb50">
            ...
            <h3 class="anc_tit">전자결제(PG) 설정</h3>
            ...
            <div class="tbl_frm01">
                <table>
                    ...
                    <tr>
                        ...
                        <td class="td_label">
                            <input type="checkbox" name="de_bank_use" value="1" id="de_bank_use"<?php echo get_checked($pt['de_bank_use'], "1"); ?>>
                            <label for="de_bank_use">무통장</label>
                            <input type="checkbox" name="de_card_use" value="1" id="de_card_use"<?php echo get_checked($pt['de_card_use'], "1"); ?>>
                            <label for="de_card_use">신용카드</label>
                            <input type="checkbox" name="de_iche_use" value="1" id="de_iche_use"<?php echo get_checked($pt['de_iche_use'], "1"); ?>>
                            <label for="de_iche_use">실시간계좌이체</label>
                            <input type="checkbox" name="de_vbank_use" value="1" id="de_vbank_use"<?php echo get_checked($pt['de_vbank_use'], "1"); ?>>
                            <label for="de_vbank_use">가상계좌</label>
                            <input type="checkbox" name="de_hp_use" value="1" id="de_hp_use"<?php echo get_checked($pt['de_hp_use'], "1"); ?>>
                    ...
                    <tr>
                        ...
                        <td> 
                            <select name="de_pg_service" id="de_pg_service">
                                <?php echo option_selected("kcp", $pt['de_pg_service'], "NHN KCP"); ?>
                                <?php echo option_selected("lg",  $pt['de_pg_service'], "LG유플러스"); ?>	
                                <?php echo option_selected("inicis", $pt['de_pg_service'], "KG이니시스"); ?>
                            </select> 
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php echo get_checked($pt['de_tax_flag_use'], "1"); ?>>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php echo get_checked($pt['de_taxsave_use'], "1"); ?>>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php echo get_checked($pt['de_card_noint_use'], "1"); ?>>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php echo get_checked($pt['de_easy_pay_use'], "1"); ?>>
                            <label for="de_easy_pay_use">사용함</label>
                            <?php echo help("주문서 작성 페이지에 PG사 간편결제(PAYCO, PAYNOW, KPAY) 버튼의 별도 사용 여부를 설정합니다."); ?>
                        </td>
                    </tr>
                    <tr>
                        <th scope="row">PG사 간편결제 서비스</th>
                        <td>
                            <input type="checkbox" name="de_easy_pay_services[]" value="naverpay" id="de_easy_pay_use" <?php echo strpos($pt['de_easy_pay_services'],"naverpay")!==false?"checked":"" ?>>
                            <label for="easy_pay_naver">네이버페이</label>
                            <input type="checkbox" name="de_easy_pay_services[]" value="kakaopay" id="easy_pay_kakao" <?php echo strpos($pt['de_easy_pay_services'],"kakaopay")!==false?"checked":"" ?>>
                            <label for="easy_pay_kakao">카카오페이</label>
                            <input type="checkbox" name="de_easy_pay_services[]" value="tosspay" id="easy_pay_toss" <?php echo strpos($pt['de_easy_pay_services'],"tosspay")!==false?"checked":"" ?>>
                            <label for="easy_pay_toss">토스페이</label>
                            <input type="checkbox" name="de_easy_pay_services[]" value="applepay" id="easy_pay_apple" <?php echo strpos($pt['de_easy_pay_services'],"applepay")!==false?"checked":"" ?>>
                            <label for="easy_pay_apple">애플페이</label>
                        </td>
                    </tr>
                    </tbody>
                </table>
            ...
            <div class="pg_info_fld kcp_info_fld">
                ...
                <h3 class="anc_tit mart30">NHN KCP 계약정보</h3>
                <div class="tbl_frm01">
                    <table>
                        <colgroup>
                            <col class="w180">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="de_kcp_mid" value="<?php echo $pt['de_kcp_mid']; ?>" id="de_kcp_mid" class="frm_input" size="10">					
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="de_kcp_site_key" value="<?php echo $pt['de_kcp_site_key']; ?>" id="de_kcp_site_key" class="frm_input" size="40">
            ...
            <div class="pg_info_fld lg_info_fld">
                <h3 class="anc_tit mart30">LG유플러스 계약정보</h3>
                <div class="tbl_frm01">
                    <table>
                        <colgroup>
                            <col class="w180">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="de_lg_mid" value="<?php echo $pt['de_lg_mid']; ?>" id="de_lg_mid" class="frm_input" size="10" maxlength="20">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="de_lg_mert_key" value="<?php echo $pt['de_lg_mert_key']; ?>" id="de_lg_mert_key" class="frm_input" size="40" maxlength="50">
            ...
            <div class="pg_info_fld inicis_info_fld">
                ...
                <h3 class="anc_tit mart30">KG이니시스 계약정보</h3>
                <div class="tbl_frm01">
                    <table>
                        <colgroup>
                            <col class="w180">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="de_inicis_mid" value="<?php echo $pt['de_inicis_mid']; ?>" id="de_inicis_mid" class="frm_input" size="10">
                        ...
                        <tr> 
                            ...
                            <td>
                                <input type="text" name="de_inicis_admin_key" value="<?php echo $pt['de_inicis_admin_key']; ?>" id="de_inicis_admin_key" class="frm_input" size="5" maxlength="4">
                        ...
                        <tr>
                            ...
                            <td>					
                                <input type="text" name="de_inicis_sign_key" value="<?php echo $pt['de_inicis_sign_key']; ?>" id="de_inicis_sign_key" class="frm_input" size="40" maxlength="50">
                        ...
                        <tr>
                            ...
                            <td>					
                                <input type="checkbox" name="de_samsung_pay_use" value="1" id="de_samsung_pay_use"<?php echo get_checked($pt['de_samsung_pay_use'], "1"); ?>>
            ...
            <h3 class="anc_tit mart30">에스크로 설정</h3>
            <div class="tbl_frm01">
                <table>
                    <colgroup>
                        <col class="w180">
                    ...
                    <tr>
                        ...
                        <td> 
                            <input type="radio" name="de_escrow_use" value="0" id="de_escrow_use_no"<?php echo get_checked($pt['de_escrow_use'], "0"); ?>>
                            <label for="de_escrow_use_no">일반결제 사용</label>
                            <input type="radio" name="de_escrow_use" value="1" id="de_escrow_use_yes"<?php echo get_checked($pt['de_escrow_use'], "1"); ?>>
            ...
            <h3 class="anc_tit mart30">무통장입금계좌</h3>
            ...
            <div class="tbl_frm01">
                <table>
                    ...
                    <tbody>
<?php
$bank = unserialize($pt['de_bank_account']);
for($i=0; $i<5; $i++) {
    $k = ($i+1);
?>
                    <tr>
...
<div class="information">
    ...
    $(function() { 
        $(".pg_info_fld").hide();
        <?php if($pt['de_pg_service']) { ?>
        $(".<?php echo $pt['de_pg_service']; ?>_info_fld").show();
        <?php } else { ?>
        $(".kcp_info_fld").show();
        <?php } ?>
...
<?php
    // 결제모듈 실행권한 체크
    if($pt['de_iche_use'] || $pt['de_vbank_use'] || $pt['de_hp_use'] || $pt['de_card_use']) {
        // kcp의 경우 pp_cli 체크
        if($pt['de_pg_service'] == 'kcp') {
