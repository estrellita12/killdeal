...
<form name="fregform" method="post" action="./design/app_push_form_update.php" onsubmit="return fregform_submit(this);"  enctype="MULTIPART/FORM-DATA" >
<input type="hidden" name="w" value="<?php echo $w; ?>">
<input type="hidden" name="sfl" value="<?php echo $sfl; ?>">
<input type="hidden" name="stx" value="<?php echo $stx; ?>">
<input type="hidden" name="page" value="<?php echo $page; ?>">
<input type="hidden" name="pu_no" value="<?php echo $pu_no; ?>">
<input type="hidden" name="q_pt_id" value="<?php echo $q_pt_id; ?>">
...
<div class="btn_confirm">
	...
	<a href="./design.php?code=app_push_list<?php echo $qstr; ?>&page=<?php echo $page; ?>" class="btn_large bx-white">목록</a>
</div>
</form>
