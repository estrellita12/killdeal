...
function printMenu2($svc_class, $subject, $url, $menu_cnt='')
{
	...
	if(is_numeric($menu_cnt)) {
		if($menu_cnt > 0){
			if($subject == "교환신청" || $subject == "반품신청" || $subject == "상품 문의관리") {
				$current_class = ' class="snb_onair"';
			} else {
...
<div id="snb">
	...
	<dl>
		...
		<?php echo printMenu2('p10', ADMIN_MENU2_17, TB_ADMIN_URL.'/partner.php?code=pbanner_list'); //(2021-02-15) 가맹점 관리를 admin으로 이동 ?>
		<?php echo printMenu2('p10', ADMIN_MENU2_18, TB_ADMIN_URL.'/partner.php?code=pgoods_plan'); //(2021-02-15) 가맹점 관리를 admin으로 이동 ?>
		<?php echo printMenu2('p10', ADMIN_MENU2_19, TB_ADMIN_URL.'/partner.php?code=ppopup_list'); //(2021-02-15) 가맹점 관리를 admin으로 이동 ?>
		...
		<?php echo printMenu2('p30', ADMIN_MENU2_12, TB_ADMIN_URL.'/partner.php?code=calculate'); ?>
		<?php //echo printMenu2('p30', ADMIN_MENU2_14, TB_ADMIN_URL.'/partner.php?code=pruoduct_sales'); ?>
		<?php echo printMenu2('p30', ADMIN_MENU2_14, TB_ADMIN_URL.'/partner.php?code=product_sales'); ?>
		<?php //echo printMenu2('p30', ADMIN_MENU2_15, TB_ADMIN_URL.'/partner.php?code=daliy'); ?>
		<?php echo printMenu2('p30', ADMIN_MENU2_15, TB_ADMIN_URL.'/partner.php?code=daily'); ?>
		<?php echo printMenu2('p30', ADMIN_MENU2_16, TB_ADMIN_URL.'/partner.php?code=daliy2'); ?>
	</dl>
	<?php }
	...
	<?php }
		...
		$pt_goods1 = admRequest("shop_goods1", "and use_aff = 1");
		$pt_goods2 = admRequest("shop_goods2", "and use_aff = 1");
		$qaCnt  = admRequest("shop_goods_qa", "and (left(seller_id,3)='AP-' or seller_id = 'admin')");
		$revCnt = review_cnt();
		$revCnt2 = review_cnt2();
		$jaego1 = admin_gs_jaego_bujog("and shop_state = 0 and use_aff = 0 and isopen=1"); // 재고부족
		$jaego2 = admin_io_jaego_bujog("and b.shop_state = 0 and b.use_aff = 0 and b.isopen=1"); // 옵션재고부족
	?>
	<dl>
		<?php echo printMenu1('g10', '상품관리'); ?>
		<?php echo printMenu2('g10', ADMIN_MENU5_01, TB_ADMIN_URL.'/goods.php?code=list'); ?>
		<?php echo printMenu2('g10', ADMIN_MENU5_18, TB_ADMIN_URL.'/goods.php?code=supply', $goods1); // (2021-03-03) ?>
		<?php echo printMenu2('g10', ADMIN_MENU5_24, TB_ADMIN_URL.'/goods.php?code=supply2', $goods2); // (2021-03-03) ?>
		<?php echo printMenu2('g10', ADMIN_MENU5_30, TB_ADMIN_URL.'/goods.php?code=supply3'); // (2022-01-05) ?>
		<?php echo printMenu2('g10', ADMIN_MENU5_19, TB_ADMIN_URL.'/goods.php?code=userlist'); ?>
		<?php echo printMenu2('g10', ADMIN_MENU5_27, TB_ADMIN_URL.'/goods.php?code=pt_goods1', $pt_goods1); // (2021-03-03) ?>
		<?php echo printMenu2('g10', ADMIN_MENU5_28, TB_ADMIN_URL.'/goods.php?code=pt_goods2', $pt_goods2); // (2021-03-03) ?>
        <?php echo printMenu2('g10', ADMIN_MENU5_29, TB_ADMIN_URL.'/goods.php?code=timesale'); // 2021-08-10 ?>
		...
		<?php echo printMenu2('g60', ADMIN_MENU5_31, TB_ADMIN_URL.'/goods.php?code=google'); // 2024-02-07 ?> 
		...
		<?php echo printMenu2('g40', ADMIN_MENU5_21, TB_ADMIN_URL.'/goods.php?code=review',$revCnt); ?>
		<?php echo printMenu2('g40', ADMIN_MENU5_32, TB_ADMIN_URL.'/goods.php?code=review2',$revCnt2); ?>
	...
	<dl>
		...
		<?//php echo printMenu2('o10', "주문리스트(현대리바트)", TB_ADMIN_URL.'/order.php?code=list2', $sodrr['cnt']); ?>
		...
		<?php echo printMenu2('o10', ADMIN_MENU6_17, TB_ADMIN_URL.'/order.php?code=calculate', $sodr14['cnt']); ?>
		...
		<?php echo printMenu1('o50', '기타관리'); ?>
		<?php echo printMenu2('o50', ADMIN_MENU6_12, TB_ADMIN_URL.'/order.php?code=memo', $memoCnt); ?>
	</dl>
	<?php }
	...
	<?php }
		...
		$eventCnt = sel_count("shop_event","where agree = 'Y'");
	?>
	<dl>
		...
		<?php echo printMenu2('h10', ADMIN_MENU8_05, TB_ADMIN_URL.'/help.php?code=event',$eventCnt); ?>
	...
	<dl>
		...
		<?php echo printMenu2('d30', ADMIN_MENU9_05, TB_ADMIN_URL.'/design.php?code=menu_form'); ?>
		<?php echo printMenu2('d30', ADMIN_MENU9_06, TB_ADMIN_URL.'/design.php?code=best_item'); ?>
		<?php echo printMenu2('d30', ADMIN_MENU9_07, TB_ADMIN_URL.'/design.php?code=popup_list'); ?>
		<?php echo printMenu2('d30', ADMIN_MENU9_29, TB_ADMIN_URL.'/design.php?code=app_push_list'); ?>
	</dl>
	<?php }
