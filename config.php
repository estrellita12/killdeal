...
define('TB_TIME_YMD2',		date("Ymd", TB_SERVER_TIME)); //현대리바트_회수완료 날짜 타입_년월일
...
if(isset($_SERVER['HTTPS']) && $_SERVER['HTTPS']=='on') {   //https 통신일때 daum 주소 js
    ...
    define('TB_POSTCODE_JS', '<script src="https://t1.daumcdn.net/mapjsapi/bundle/postcode/prod/postcode.v2.js"></script>');
