...
<input type="hidden" name="mb_recommend" id="reg_mb_recommend" value="admin">
...
<div class="tbl_frm01 tbl_wrap">
	...
	<tr>
		...
		<td>
			...
			<span class="frm_info" style="display:none">
				<label><input type="checkbox" name="mb_sms" value="Y" checked> 휴대폰 문자메세지를 받겠습니다.</label>
			</span>
	...
	<tr>
		...
		<td>
			...
			<span class="frm_info" style="display:none">
				<label><input type="checkbox" name="mb_mailling" value="Y" id="reg_mb_mailling" checked> 정보 메일을 받겠습니다.</label>
			</span>
		</td>
	</tr>
	...
	<tr>
		<th scope="row">소개URL</th>
		<td>
            <textarea class="frm_textbox wfull required" name="mb_memo" required></textarea>
		</td>
	</tr>    
	<?php } ?>
