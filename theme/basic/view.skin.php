...
<!-- 			</ul> -->
			...
			<div class="share_box">
				<div class="review_box" onclick="javascript:pg_anchor('tab2')" style="float:unset;margin:auto;cursor:pointer;width:60%">
					<div>
                        <span><img src="<?php echo TB_IMG_URL; ?>/sub/review_star<?php echo $star_score; ?>.png" alt="상품리뷰점수"></span>
                        <span style="margin-left:4px;font-size:22px; font-weight:bold"><?php echo $review_avg; ?></span>
                    </div>
...
<div class="vi_rel_sort marb30">
	...
	$sql_search = " and ( index_no != '{$gs['index_no']}' and ( model like '%{$gs['model']}%' or ca_id like '$ca_id%' or ca_id2 like '$ca_id%' or ca_id3 like '$ca_id%' ) ) ";
	$sql_common = sql_goods_list($sql_search);
    ...
    // 2023-02-25
    $sql_case = "  case when model like '%{$gs['model']}%' then 1 when ca_id3 like '{$ca_id}%' then 2 else 3 end as s_order  ";
    $sql_order = " order by s_order ";
	...
	$sql = " select *,$sql_case $sql_common $sql_order limit $total_count ";
