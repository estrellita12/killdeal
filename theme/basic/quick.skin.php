...
?>
    ...
    <a href="https://pf.kakao.com/_hwBgxb"><img src="https://killdeal.co.kr//img/kakao_baksajang.png" style="background:#666; margin: 0px 1px 1px 1px; padding: 8px 15px; width: 48px; height: 48px;"></a>
    <?php } ?>
