...
<!-- <div class="cont_wrap mart60 marb99">
	...
	<?php echo get_listtype_skin2("4", '235', '235', '12', 'wli4 mart5'); ?>
</div> -->
<!-- } 인기상품 끝 -->
            ...
            <li>
                ...
                <?php } ?>
                    <dl>
                        <dt><?php echo $it_image;?></dt>
                        <dd class="pname"><?php echo $it_name; ?></dd>
                        <dd class="price"><?php echo $sale; ?> &nbsp;<span class="price_box"><?php echo $it_sprice;?><span class="recommendation">특별할인★</span><?php echo $it_price;?></span></dd>
                    </dl>
                </a>
            </li>
    <?php } ?>
