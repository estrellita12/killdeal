...
function forderform_check(f)
{
    ...
    switch(f.od_settle_case.value)
    {
        ...
        case "간편결제":
            ...
            */
            // 2024-01-29
            if(typeof f.LGD_EASYPAY_TRANTYPE === "undefined") {
                var input = document.createElement("input");
                input.setAttribute("type", "hidden");
                input.setAttribute("name", "LGD_EASYPAY_TRANTYPE");
                input.setAttribute("value", "");
                f.LGD_EASYPAY_ONLY.parentNode.insertBefore(input, f.LGD_EASYPAY_ONLY);
            }
            f.LGD_CUSTOM_USABLEPAY.value = "SC0010";
            <?php if(get_session("easy_pay_service")=="easy_naverpay"){  ?>
            f.LGD_EASYPAY_ONLY.value = "NAVERPAY_CARD";
            f.LGD_EASYPAY_TRANTYPE.value = "NAVERPAY_CARD";
            <?php } else if(get_session("easy_pay_service")=="easy_kakaopay"){  ?>
            f.LGD_EASYPAY_ONLY.value = "KAKAOPAY";
            f.LGD_EASYPAY_TRANTYPE.value = "KAKAOPAY";
            <?php } else if(get_session("easy_pay_service")=="easy_tosspay"){  ?>
            f.LGD_EASYPAY_ONLY.value = "TOSSPAY";
            f.LGD_EASYPAY_TRANTYPE.value = "TOSSPAY";
            <?php }else{ ?>
            f.LGD_EASYPAY_ONLY.value = "TOSSPAY";
            f.LGD_EASYPAY_TRANTYPE.value = "TOSSPAY";
            <?php } ?>
