		...
		<tr>
			...
			<td class="td_label">
				...
				if($default['de_vbank_use']) {
					echo '<input type="radio" name="paymethod" id="paymethod_vbank" value="가상계좌" onclick="calculate_paymethod(this.value);"> <label for="paymethod_vbank">무통장입금</label>'.PHP_EOL;
				}
