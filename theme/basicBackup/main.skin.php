...
<?php
 if(!($pt_id == "srixon")) //20190727_스릭슨 별도 메인페이지 구성
 {
?>
...
<div class="cont_wrap marb20">
	<h2 class="mtit"><span>BEST30</span><a id="cate_addr" href="<?php echo TB_SHOP_URL; ?>/listtype.php?type=2">더보기 ></a></h2>
...
<div class="cont_wrap marb20">
	<h2 class="mtit media_cont"><span>미디어 컨텐츠</span><a class="btn_link" href="<?php echo "bbs"; ?>/list.php?boardid=42">골프영상 더보기 ></a></h2>


<!-- 골프비디오 시작 { -->
<!-- 골프비디오 수정 20191014 더보기 버튼 추가, 골프비디오 게시판 연결 -->
	<div class="golfvideo">
		<!-- <h2 class="mtit"><span>골프영상</span><a href="<?php echo "bbs"; ?>/list.php?boardid=42">더보기 ></a></h2> -->
		<div class="video_wrap">
<!-- 			<?php echo board_video_latest(42, 100, 1, $pt_id); ?> 레이아웃 변경 20200729 주석 -->
			<?php echo video_thumb(42, 100, 2, $pt_id); ?>
		</div>
<!-- } 골프비디오 끝 -->
	</div>
	<!-- 골프매거진 시작 {-->
	<div class="golf_mgz_wrap">
		<a class="btn_link" href="<?php echo "bbs"; ?>/list.php?boardid=43">골프매거진 더보기 ></a>
		<ul>
			<?php echo board_mgz_latest(43, 100, 4, $pt_id); ?>
		</ul>
	</div>
<!-- } 골프매거진 끝 -->
...
<div class="cont_wrap marb20">
	...
	<?php echo get_listtype_skin("3", '256', '256', '10', 'wli5 mart40'); ?>
</div>
<!-- } 신상품 끝 -->
...
<?php
 ...
 else //스릭슨_20190727_메이저월드
 {
	 ?>
   <img src="http://image.killdeal.co.kr/srixon_main.jpg" width="100%">
