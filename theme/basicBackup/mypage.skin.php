		...
		<div id="smb_my_act">
			<ul>
			    ...
			    ?>
				     ...
				     <li><a href="<?php echo TB_BBS_URL; ?>/leave_form.php" class="btn_lsmall red">회원탈퇴</a></li>
			    <? } ?>
			</ul>
		</div>
				...
				<td>
					<div class="ini_wrap">
						...
						<tr>
							...
							<td class="vat tal">
								<a href="<?php echo $href; ?>"><?php echo get_text($ct['gname']); ?></a>
								...
								<?php echo $it_options ?>
								<?php if($ct['dan'] == 5) { ?>
								<p class="padt3"><a href="<?php echo TB_SHOP_URL; ?>/orderreview.php?gs_id=<?php echo $ct['gs_id']; ?>&od_id=<?php echo $ct['od_id']; ?>" onclick="win_open(this, 'winorderreview', '650', '530','yes');return false;" class="btn_ssmall bx-white">구매후기 작성</a></p>
								<?php } ?>
							</td>
						</tr>
						</table>
