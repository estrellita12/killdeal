...
<div id="qcl">
	...
	<h2 class="qcl_name"><img src="/img/killdeal_sale_title.png" alt="킬딜특가"></h2>
	<?php } else {?>
	<h2 class="qcl_name"><img src="/img/hong_killdeal_logo.png" alt="킬딜특가"></h2>
	<?php }?>
	<div class="slide">
		<ul>
			<?php
			...
			for($i=0; $row=sql_fetch_array($result); $i++) {
				...
				//$i++;
			?>
			<li class="n<?php echo $k; ?>">
				<a href="<?php echo $it_href; ?>">
					<?php echo $it_image; ?>
					<span class="pname"><?php echo $it_name; ?></span>
					<span class="price"><span class="price_box <?php if($pt_id == 'honggolf') echo 'hong_price'?>">회원가 보기</span></span>
				</a>
				<?php
				}
				if(!$i)
		...
		<?php if($i > 0){ ?>
		<div class="stv_wrap <?php if($pt_id == 'honggolf')echo 'hong_stv' ?>">
			<span id="prev">&lt;</span><span id="stv_pg"></span><span id="next">&gt;</span>
		</div>
		<?php } ?>
	</div>
		<?php if($pt_id == 'honggolf'){ ?>
	<div id="hong_link_wrap" style="text-align:center;">
		<a href="https://www.honggolf.com/shop" style="display:block;" >
		<img src="/img/honggolf_link_img.png" style="width:130px;">
		<span style="display:block;font-size:16px;font-weight:700;color:#17889a;padding:5px 0;">자사상품보기</span>
	</a>
	</div>
		<?php } ?>
</div>
...
<!-- 퀵메뉴 우측날개 시작 { -->
<div id="qcr">
	<p class="qcr_tit">오늘 본 상품<br><span style="font-size:12px;">(스크롤)</span></p>
	<ul>
		<li>
			<?php
	...
	<a href="<?php echo TB_SHOP_URL; ?>/cart.php" class="qcr_btn qcr_btn_cart"><i><span class="ic_num"><?php echo get_cart_count(); ?></span></i>장바구니</a>
	<!-- 주문/배송조회  -->
