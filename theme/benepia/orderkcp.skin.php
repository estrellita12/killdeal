...
$order_action_url = "https://mjg.kr/theme/benepia/kcp/kcp_api_page.php";
?>
...
<div id="display_pay_button" class="btn_confirm">
	<input type="submit" value="결제하기" class="btn_large wset">
...
function forderform_check(f)
{
    ...
    switch(f.od_settle_case.value)
    {
        ...
        case "신용카드":
            /*
            <?php 
                echo "console.log("."'".$pt_id."'".");" ;
                $creditCode = $pt_id === "mjg" ? "100100000000" : "100000000000";
            ?>
            f.pay_method.value   = <?php echo $creditCode; ?>;
            */
