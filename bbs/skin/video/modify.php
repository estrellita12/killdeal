...
if($index_no == '') {
	...
	$write = sql_fetch("select * from shop_board_{$boardid} where index_no = '{$index_no}' ");
		if(!$write['index_no'])
		alert('자료가 존재하지 않습니다.');
}
?>
...
<div class="tbl_frm01 tbl_wrap">
	...
	<tr>
		...
		<td>
			<input type="checkbox" name="main_use" value="1" id="main_use"<?php echo get_checked($write['main_use'], "1"); ?>> <label for="main_use">노출함 /</label>
			 <label for="main_order">노출순서</label> <input type="text" name="main_order" value="<?php echo $write['main_order']; ?> " class="frm_input"> <br>숫자가 작을수록 우선 순위로 노출 됩니다.
		</td>
	</tr>
	<?php } ?>
	<tr>
