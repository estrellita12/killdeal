...
<div class="webzine">
	...
	<dl>
		...
		<dd class="bo_tit">
			<p class="bo_notice">공지</p> <?php echo $bo_subject; ?><?php if($row['issecret'] == 'Y') { ?>&nbsp;<img src="<?php echo $bo_img_url; ?>/img/icon_secret.gif" alt="i"><?php } ?><?php echo $bo_newicon; ?>
		</dd>
		<dd><?php echo $row['writer_s']; ?><span><?php echo $bo_wdate; ?><!-- 20191128 조회수 주석</span><span>조회 : <?php //echo $row['readcount']; ?></span> --></dd>
