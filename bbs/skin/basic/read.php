...
<?php if($is_member) { ?>
<table class="wfull bd coment_form">
<tr class="list1">
	<td class="tac bold"><?php echo $member['name']; ?></td>
	<td><label><textarea name="memo" class="frm_textbox h60"></textarea></label></td>
...
<table class="wfull bd coment_form">
<tr class="list1">
	<td class="tac bold"><?php echo $bo_writer_s; ?></td>
	<td><textarea name="memo" class="frm_textbox h60"></textarea></td>
