...
<!--20191219 인풋타입 수정, 도담골프 분기설정-->
<input type="hidden" name="site_name" value="<?php if($pt_id=="dodamgolf"){echo "도담골프";}else if($pt_id=='golf'){echo "H골프";} else{echo $default['de_kcp_mid'];}; ?>">
...
<input type="hidden" name="tosspay_direct" value="A" >
...
<?php 
    $pt_memcorp_cd = $pt_id === "mjg" ? "z665"/*베네피아 제휴사 코드*/ : "";
    console_log($pt_memcorp_cd ? "is" : "isNot");
?>
<input type="hidden" name="pt_memcorp_cd" value=<?php !empty($pt_memcorp_cd) ? $pt_memcorp_cd : "" ?>/>
