...
// 2021-10-21 가상계좌 입금 기한 설정 
$LGD_CLOSEDATE           = date('YmdHis', strtotime("+3 days",TB_SERVER_TIME));
?>
...
<input type="hidden" name="LGD_CLOSEDATE" id="LGD_CLOSEDATE" value="<?php echo $LGD_CLOSEDATE; ?>">     <!-- 가상계좌 유효기간 -->
