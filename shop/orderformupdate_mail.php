	...
	<td style="padding:24px 14px 0;">
		...
		<tr>
			<td style="padding:50px 0 0 10px; font-size:12px; font-family:Gulim; color:#393939; line-height:19px;">
				<p>안녕하세요. <strong><?php if($pt_id == 'itsgolf'){ echo "이츠골프"; }
										else{ echo $config['company_name']; } ?></strong> 입니다.<br>
			...
			<td>
				...
				<tr>
					<td style="padding:23px 0 0;">
						<p style="margin:0 0 25px 10px">고객님께서는 <strong><?php echo substr($od['od_time'],0,10);?></strong>에 <strong><?php if($pt_id == 'itsgolf'){ echo "이츠골프"; }
										else{ echo $config['company_name']; } ?></strong>에서 아래와 같은 상품을 주문하셨습니다.</p>
		...
		<tr>
			<td style="padding:30px 0 30px 10px; font-size:12px; font-family:Gulim; color:#393939; line-height:19px;">
				...
				<p style="margin-top:13px;">다시 한번 저희 쇼핑몰을 이용해주신 <strong><?php if($pt_id == 'itsgolf'){ echo "이츠골프"; }
										else{ echo $config['company_name']; } ?>(<?php echo $od['name']; ?>)</strong> 고객님께 진심으로 감사드립니다.</p>
			</td>
		</tr>
		<tr>
...
<tr>
	<td style="padding:24px 34px; font-family:Gulim; font-size:12px; line-height:18px; background-color:#cacdd4; color:#fff;">
	   ...
	   <p>Copyright(c) <?php if($pt_id == 'itsgolf'){ echo "이츠골프"; }
										else{ echo $config['company_name']; } ?> all rights reserved.</p>
	</td>
</tr>
</tbody>
</table>