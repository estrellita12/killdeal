...
<dl>
	...
	<?php //echo printMenu2(1, '상품 API 등록', asideUrl.'?code=partner_recommend_item'); ?>
	...
	<?php //} ?>
	<?php if($member['grade']=='5') {  ?>
	<?php echo printMenu1(12, '상품관리'); ?>
	<?php echo printMenu2(12, '전체 상품목록', asideUrl.'?code=partner_all_goods_list'); ?>
    <?php } ?>
	<?php if($member['grade']!='5') {  ?>
	...
	<?php echo printMenu1(5, '주문관리'); ?>
	<?php //echo printMenu2(5, '본사 상품목록', asideUrl.'?code=partner_goods_admlist'); ?>
	<?php echo printMenu2(5, '주문리스트', asideUrl.'?code=partner_order_admlist');  // ?>
	<?php //echo printMenu2(5, '상품판매 정산 리스트', asideUrl.'?code=partner_order_calculate'); ?>
    ...
    <?php // (2021-02-01) 이름 변경   ?>
	<?php echo printMenu1(7, '판매관리'); //echo printMenu1(7, '주문관리'); ?>
	<?php echo printMenu2(7, '판매리스트', asideUrl.'?code=partner_odr_list', $sodrr['cnt']); // echo printMenu2(7, '주문리스트(전체)', asideUrl.'?code=partner_odr_list', $sodrr['cnt']); ?>
