...
<div class="tbl_head01">
	...
	<tr class="<?php echo $bg; ?>">
		...
		<td>    
            <?php 
                if($member['id']=='baksajang'){ 
                    $delivery_com = '로젠택배|http://www.ilogen.com/web/personal/trace/'; 
                }else{ 
                    $delivery_com = $row2['delivery'];
                } 
            ?>
			<?php echo get_delivery_select("delivery[".$chk_cnt."]", $delivery_com ); ?>
		</td>
