	...
	<tr>
		...
		<td>
			...
			<tr>
				...
				<td><input type="text" name="delivery_price" value="<?php echo number_format($partner['delivery_price']); ?>" class="frm_input" size="10" onkeyup="addComma(this);"> 원을 주문금액 또는 수량에 상관없이 동일 주문건에 배송비를 한번만 부과됩니다
			</tr>
			<tr>
				<th scope="row">
