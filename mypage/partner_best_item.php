...
<form name="fregform" method="post" action="./partner_best_item_update.php">
...
<div class="tbl_head01">
	...
	<tr>
		...
		<td><input type="text" name="de_maintype_title" value="<?php echo $partner['de_maintype_title']; ?>" required itemname="최상위 타이틀명" class="required frm_input wfull" placeholder="최상위 타이틀명"></td>
		<td></td>
	</tr>
	<?php
