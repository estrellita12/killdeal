...
<div class="tbl_frm02">
    ...
    <tr>
        ...
        <td>
            <input type="text" value="<?php echo $gs['index_no']; ?>" itemname="상품코드" class="frm_input"<?php echo $readonly; ?>>
            <a href="<?php echo TB_SHOP_URL; ?>/view.php?index_no=<?php echo $gs_id; ?>" target="_blank" class="btn_small">미리보기</a>
	...
	<tr>
		...
		<td class="td_label">
            ...
            <?php //}else{?>
            <!-- <input type="hidden" name="isopen" value="4"> -->
			<?php //echo help("상품 등록시 판매중지로 초기세팅 됩니다. 담당 MD 승인 후 진열 상태로 변경 될 예정입니다."); ?>
            <?php //} ?>
		</td>
	</tr>
	<tr>
