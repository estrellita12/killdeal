...
if($w == 'u') {
    // (2021-01-11) 가맹점 기획전 추가 금지
	//$frm_submit .= '<a href="./page.php?code=partner_goods_plan_form" class="btn_large bx-red">추가</a>'.PHP_EOL;
}
$frm_submit .= '</div>';
?>

<form name="fregform" method="post" action="./partner_goods_plan_form_update.php" onsubmit="return fboardform_submit(this);" enctype="MULTIPART/FORM-DATA">
