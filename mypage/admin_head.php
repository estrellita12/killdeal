...
/*
// 2022-02-18
if( $member['id']=='ncnature' && $_SERVER['HTTP_HOST']!='dukhomall.com' ){
    session_unset();
    session_destroy();
    alert('올바른 방법으로 이용해 주세요.','https://mwo.kr');
}
*/
...
<div id="header"<?php if($admin_seller) { ?> class="supply"<?php } ?>>
	...
	<h1><a href="<?php echo TB_MYPAGE_URL; ?>/page.php?code=partner_order_admlist">가맹점 관리자</a></h1>
	<?php } ?>
	<?php if($admin_seller) { ?>
	...
	<div id="tnb">
		<ul>
			...
			<li><a href="<?php echo TB_MYPAGE_URL; ?>/page.php?code=partner_order_admlist">가맹점 관리</a></li>
			<?php } ?>
