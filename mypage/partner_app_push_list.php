...
<a href="./page.php?code=partner_app_push_form" class="fr btn_lsmall red"><i class="ionicons ion-android-add"></i> 추가하기</a>
EOF;
?>
...
<form name="fpopuplist" id="fpopuplist" method="post" action="./partner_app_push_list_update.php" onsubmit="return fpopuplist_submit(this);">
...
<div class="tbl_head01">
	...
	for($i=0; $row=sql_fetch_array($result); $i++) {		
		$pu_no = $row['pu_no'];
		$a_upd = "<a href='./page.php?code=partner_app_push_form&w=u&pu_no=$pu_no$qstr&page=$page' class=\"btn_small\">수정</a>";
