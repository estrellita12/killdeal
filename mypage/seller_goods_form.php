...
<div class="tbl_frm02">
	...
	<tr>
		...
		<td>
			<input type="text" name="mb_id" value="<?php echo $gs['mb_id']; ?>" required itemname="업체코드" class="required frm_input" readonly style="background-color:#ddd;">
		</td>
	</tr>
	<tr>
	...
	<tr>
		<th scope="row">상품코드2(사방넷)</th>
		<td>
			<input type="text" name="gcode" value="<?php echo $gs['index_no']; ?>" required itemname="상품코드" class="required frm_input"<?php echo $readonly; ?>>
			<?php if($w == "u") { ?><a href="<?php echo TB_SHOP_URL; ?>/view.php?index_no=<?php echo $gs_id; ?>" target="_blank" class="btn_small">미리보기</a><?php } ?>
		</td>
	</tr>
	<tr>
    ...
    <tr>
        ...
        <td><input type="text" name="make_year" value="<?php echo $gs['make_year']; ?>" class="frm_input" placeholder="2022"></td>
    </tr>
    <tr>
        <th scope="row">제조 일자</th>
        <td><input type="text" name="make_dm" value="<?php echo $gs['make_dm']; ?>" class="frm_input" placeholder="20220222"></td>
    </tr>
	<tr>
...
<div class="tbl_frm02">
	...
	<tr>
		<th scope="row">수수료</th>
		<td>
			<input type="text" name="seller_comm" value="<?php echo number_format($gs['seller_comm']); ?>" class="frm_input w80" onkeyup="addComma(this);"> %
			<span class="fc_197 marl5">공급사 수수료</span>
		</td>
	</tr>
	<tr>
		<th scope="row">포인트</th>
