...
$sql_search = " where dan not in (0,6,7,9,10,11) and pt_id = '{$member['id']}' ";
...
<div class="tbl_head01">
	...
	<tr class="<?php echo $bg; ?>">
		...
		<td class="td_address"><?php echo $row2['addr1']." ".$row2['addr2']." ".$row2['addr3']; ?></td>
		<td><?php echo preg_replace("/[ #\&\+\-%@=\/\\\:;,\.'\"\^`~\_|\!\?\*$#<>()\[\]\{\}]/i", "", $row2['cellphone']); ?></td>
		...
		<td class="tar"><?php echo number_format($row2['use_point'] + $row2['use_point2'] ); ?></td>
