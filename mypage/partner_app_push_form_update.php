...
if($w == '') {
	...
	goto_url(TB_MYPAGE_URL."/page.php?code=partner_app_push_list&w=u&pu_no_no=$pu_no");

} else if($w == 'u') {
	update("shop_app_push", $value, "where pu_no='$pu_no'");

	goto_url(TB_MYPAGE_URL."/page.php?code=partner_app_push_list&w=u&pu_no=$pu_no$qstr&page=$page");
}
?>
