...
<div class="tbl_frm01">
	...
	<tr>
		...
		<td>
			...
			<?php //echo radio_checked('od_status', $od_status, '1', $gw_status[1]); // (2021-02-02) 입금대기 가리기  ?>
...
<div class="local_ov mart30">
    ...
    <strong class="ov_a">취소제외 총 주문금액 : <?php echo number_format($tot_orderprice-$tot_cancelprice); ?>원</strong>
</div>
