...
// (2020-12-10)마니아몰만 모든 페이지에 띄우는 팝업
$sql = " select *
            from shop_popup
...
?>
    ...
    function funLoad(){
                ...
                $('.hd_pops_con a').css({'display':'block'});
                $('.hd_pops_con a').css({'width':'100%'});
                $('.hd_pops_con img').css({'width':'100%'});
                $('.hd_pops_con img').css({'max-width':'350px'});
                $('.hd_pops_con img').css({'height':'auto'});
    }
