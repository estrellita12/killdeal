	...
	<div class="ws_wrap">
		...
		<tr>
			<td class="wish_img">
				...
				<?php } else { ?>
				<!-- 20200518주석 체크박스/장바구니/구매하기 버튼제거 (찜한상품 목록만 보여주는 페이지로 변경) -->
				...
				<a href="<?php echo TB_MSHOP_URL; ?>/view.php?gs_id=<?php echo $row['gs_id'];?>"><?php echo get_it_image($row['gs_id'], $row['simg1'], 60, 60); ?></a>
			</td>
			...
			<td class="wish_info">
				...
				<div class="wish_del"><a href="<?php echo TB_MSHOP_URL; ?>/wishupdate.php?w=d&wi_id=<?php echo $row['wi_id'];?>" class="btn_small grey">삭제</a></div>
			</td>
		</tr>
		<?php } ?>
		</tbody>
