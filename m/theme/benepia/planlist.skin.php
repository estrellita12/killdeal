...
<!-- 20200121_모바일 이미지맵 start -->
<script src="<?php echo TB_JS_URL; ?>/jquery.rwdImageMaps.min.js"></script>
<style type="text/css">
	img[usemap] {
	...
	#cont_view img {margin:0 auto;width:100%;}
</style>
 <script>
...
<!-- 20200121_모바일 이미지맵 end -->

<!-- 상세보기 start  origin : echo get_image_resize($pl['pl_memo'] ); -->
<div id="cont_view"><?php echo conv_content($pl['pl_memo'], 1); ?></div>
<!-- 상세보기 end -->
	...
	if(!$total_count) {
		...
		for($i=0; $row=sql_fetch_array($result); $i++) {
			...
			echo "<li>";
				echo "<a href=\"{$it_href}\">";
				echo "<dl>";
					echo "<dt><img src=\"{$it_imageurl}\" alt=\"관련상품이미지\"></dt>";
