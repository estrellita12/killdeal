...
?>
	...
	<footer id="ft">
		<ul class="ft_menu">
			...
			<?php } ?>
			<li><a href="tel:070-4938-5588">고객센터</a></li>
			<li><a href="javascript:saupjaonopen('<?php echo conv_number(1058770457); ?>');">사업자정보확인</a></li>
		</ul>
		<!-- <dl class="ft_cs">
			<dt>고객센터 / 계좌안내</dt>
		...
		<dl class="ft_address">
			<dd>(주)이엑스스포테인먼트 <span class="g_hl"></span> <span class="">대표자 : 류주한</span></dd>
			<dd>주소: 서울시 강서구 화곡로 68길 15 아벨테크노 지식산업센터 1107호</dd>
			<dd>전화 : 070-4938-5588 <span class="g_hl"></span> <span class="">이메일 : k.dealhelp@gmail.com</span></dd>
			<dd>통신판매업신고 : 제 2017-서울영등포-0148</dd>
			<dd>사업자등록번호 : 105-87-70457</dd>
			<dd>개인정보보호책임자 : 류주한 </dd>
		</dl>
	</footer>
</div>
