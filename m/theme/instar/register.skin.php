...
<div class="s_cont">
    ...
    <!--2022-10-12 14세 이상 확인 체크박스 추가-->
    <div class="fregister_agree">
		<h3 class="fr_tit">
			만 14세 이상 여부 확인 (필수)
		</h3>
		<p class="agree_chk" style="border-top:none">
			<input name="agree3" type="checkbox" value="1" id="agree31" class="css-checkbox">
			<label for="agree31" class="css-label">본인은 만 14세 이상입니다.</label>
		</p>
	</div>    
	<div class="fregister_agree">
		<h3 class="fr_tit">
...
function fregister_submit(f)
{
    ...
    //<!--2022-10-12 14세 이상 확인 체크박스 추가-->
    if(!f.agree3.checked) {
		alert("만 14세 이상 확인 여부 항목을 체크 해 주세요.");
		f.agree3.focus();
		return false;
	}
