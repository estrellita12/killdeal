...
?>
	...
	<footer id="ft">
		...
		<dl class="ft_address">
			...
			<dd>리프레쉬클럽 <?php echo $config['company_tel']; ?> <span class="g_hl"></span> <span class="">대표자 : <?php echo $config['company_owner']; ?></span><br><span class="">이메일 : <?php echo $super['email']; ?></dd>
