...
<div id="sub_bn_wrap"><div class="sub_bn_box" style="background:url('/data/category/xQYMWq2zAV1nDwluthNQrTBnSdGKRb.jpg') no-repeat center; background-size: cover; padding-bottom:137px "></div></div>
		...
		for($i=0; $row=sql_fetch_array($result); $i++) {
			...
			echo "<li>";
				...
				echo "<dl>";
					...
					echo "<dd class=\"price\">{$sale}&nbsp;{$it_sprice}<span class=\"recommendation\">특별할인★</span>{$it_price}</dd>\n";
