...
<div class="sp_wrap">
    ...
    <!--
	<div class="sp_sns review_box" style="cursor:pointer" onclick="javascript:chk_tab(2);">
		<ul>
    ...
    -->
	<div class="review_box" onclick="javascript:chk_tab(2)" style="text-align:center;cursor:pointer">
        <span style="vertical-align:super"><img src="<?php echo TB_IMG_URL; ?>/sub/review_star<?php echo $star_score; ?>.png" alt="상품리뷰점수" class="w100"></span>
        <span style="margin-left:4px;font-size:18px; font-weight:bold"><?php echo $review_avg; ?></span>
		<span style="margin-left:4px;font-size:17px;" class="review_cnt">(<?php echo number_format($item_use_count); ?>)</span>
	</div>
...
function chk_tab(n) {
    ...
    $('html').animate({scrollTop: $("#fix_banner_wrap").offset().top}, 500);
}
...
<div class="vi_rel_sort">
	...
	$sql_search = " and ( model like '%{$gs['model']}%' and index_no != '{$gs['index_no']}' ) ";
	$sql_common = sql_goods_list($sql_search);
