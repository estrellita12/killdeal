...
if($pt_id == 'itsgolf'){
    include_once(TB_MTHEME_PATH.'/itsgolf_slideMenu.skin.php');
}
else if($pt_id=='refreshclub'|| $pt_id == 'teeshot'){
?>
...
<div id="wrapper">
	...
	<header id="header" style="height:97px">
		...
		<div id="its_hd_sch">
			<section style="width:80%; margin-left:19%">
				...
				<input type="text" name="ss_tx" value="<?php echo $ss_tx; ?>" class="search_inp" maxlength="20">
			...
			function back_btn()
			{
				...
				else
				{
                    ...
                    webkit.messageHandlers.cordova_iab.postMessage(JSON.stringify({message: "main"}));
				}
			}
			</script>
