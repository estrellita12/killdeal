...
<div id="sod_fin">
	...
	<form id="forderform" name="forderform" method="post" autocomplete="off">
...
function pay_approval()
{
	...
	switch(pf.od_settle_case.value) {
		...
		case "간편결제":
            ...
            f.P_RESERVED.value = f.P_RESERVED.value.replace("&useescrow=Y", "")+"&d_npay=Y";
            ...
            f.P_RESERVED.value = f.P_RESERVED.value.replace("&useescrow=Y", "")+"&d_tosspay=Y";
            <?php }else{ ?>
            f.P_RESERVED.value = f.P_RESERVED.value.replace("&useescrow=Y", "")+"&d_tosspay=Y";
            <?php } ?>
			break;
