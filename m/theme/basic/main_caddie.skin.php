...
.bestca_tab1 li {width:150px; border:solid 1px #EAEAEA; background:#fff;margin:0}
.bestca_tab1 li:nth-child(1) { border-radius: 12px 0 0 0; }
.bestca_tab1 li:nth-child(2) { border-radius: 0 12px 0 0; }
.bestca_tab1 li:nth-child(3) { border-radius: 0 0 0 12px; }
.bestca_tab1 li:nth-child(4) { border-radius: 0 0 12px 0; }
.bestca_tab1 li:nth-child(1) span { border-radius: 12px 0 0 0; }
.bestca_tab1 li:nth-child(2) span{ border-radius: 0 12px 0 0; }
.bestca_tab1 li:nth-child(3) span{ border-radius: 0 0 0 12px; }
.bestca_tab1 li:nth-child(4) span{ border-radius: 0 0 12px 0; }



.bestca_tab1 li:nth-child(odd) { justify-self: end; }
.bestca_tab1 li:nth-child(even) { justify-self: start; }

.bestca_tab1 li.active { border:solid 1px #415FCE;}
.bestca_tab1 li.active { background-color:#fff;}
.bestca_tab1 li span {display:block; width: 100%; line-height:35px; background:#fff; color:#636363; font-weight: 700; text-align: center; font-size: 14px;}
.bestca_tab1 li.active span{background:none; color:#415FCE; font-weight: 700;}
.bestca_tab1 li a{display:block; width: 100%; line-height:26px; background:#fff; border-radius:30px; text-decoration:none;}
.bestca_tab1 li.active a{background:none; color:#fff;}
.bestca ul {display:none;}

.pr_desc.wli1 dl{display: grid; grid-template-columns: 1fr 1fr; padding-top:10px;align-items: center;}
.pr_desc.wli1 li div{padding-left:10px;}
.pr_desc.wli1 li .pname{font-size:15px; text-align: start;}
.pr_desc.wli1 li .realPrice span{font-size:20px; padding:5px 0px; font-weight: 900;}


.golfvideo_wrap  .video_wrap .video_box .video_c_title{text-align: start; padding: 10px 0 5px 0; font-weight:600; font-size:13px;}
.golfvideo_wrap  .video_wrap .video_box .video_c_reg{text-align: start; padding-bottom: 20px; color:#9F9F9F;font-size:13px;}
...
<div class="m_main_cont">
	<h2 class="mtit"><span>월간베스트</span> <a href="<?php echo TB_SHOP_URL; ?>/listtype.php?type=2" class="mainPlus">더보기 +</a></h2>
	<?php if($default['de_listing_best'] == '1') { ?>
		...
		<ul class="bestca_tab1 <?php if($pt_id == 'honggolf') echo 'hong_best_tab' ?>">
			...
			<li data-tab="bstab_c<?php echo $j; ?>"><span><?php echo $i>0 ? trim($list_best[$i]['subj']) : '전체'; ?></span></li> 
			<?php } ?>
		</ul>
...
<div class="m_main_count">
    ...
    $sql = " select * $sql_common $sql_order limit 1";
    $result = sql_query($sql);
    if( $total_count > 0 ) {
    ?>
    ...
    <!--
    <div class="timeBox">
            <img src="/img/timesale_top_banner2.png"> <a href="<?php echo TB_MSHOP_URL; ?>/timesale.php" class="mainPlus">더보기 +</a>
    </div>
    -->
    <ul class="pr_desc wli1">
        ...
        ?>
            <li style="position:relative">
                ...
                <dl>
                    ...
                    <div>
                        <dd class="pname"><?php echo $it_name; ?></dd>
                        <dd class="price"><p class="realPrice"><?php echo $it_price; ?></p><?php echo $sale; ?><?php echo $it_sprice; ?></dd>
                    </div>
                </dl>
                </a>
            </li>
...
<!-- 골프매거진 시작 {-->
<div class="m_main_cont">
	<h2 class="mtit"><span>매거진</span><a href="<?php echo TB_BBS_URL; ?>/list.php?boardid=43" class="mainPlus">더보기 +</a></h2>
	<div class="pr_desc mgz_wrap">
		<ul>
			<?php echo m_board_mgz_latest2(43, 100, 2, $pt_id); ?>
		</ul>
    </div>
...
<div class="m_main_cont">
    <div class="golfvideo_wrap">
        <div class="cont_wrap">
            <h2 class="mtit"><span>영상</span><a href="<?php echo TB_BBS_URL; ?>/list.php?boardid=42" class="mainPlus">더보기 +</a></h2>
            <div class="video_wrap">
                <div class='video_box'>
                    <?php echo m_board_video_latest3(42, 100, 2, $pt_id); ?>
                </div>
            </div>
        </div>
...
<div class="m_main_cont">
	...
	<?php echo mobile_display_goods2('3', '4', $default['de_pname_3'], 'pr_desc wli2'); ?>
</div>
<!-- } 신상품 끝 -->
