...
<?php } // 인스타그램 ?>
    ...
    <footer id="ft">
        <ul class="ft_menu">
            ...
            <?php 
            if($pt_id != 'cokgolf'){
                echo '<li><a href="'.TB_URL.'/index.php?device=pc">PC버전</a></li>';
            }
            ?>
            ...
            <?php if($pt_id=="baksajang"){?>
                <li><a href="https://pf.kakao.com/_hwBgxb"><img src="https://killdeal.co.kr//img/kakao_baksajang.png" style="width:25px;"></a></li>
            <?php 
                echo "<script> 
                            $('.ft_menu').children().css('width','20%');
                            $('.ft_menu').css('padding','1%');
                      </script>";
            } ?>
        </ul>
        <dl class="ft_address">
