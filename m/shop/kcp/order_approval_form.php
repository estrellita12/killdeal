...
include_once(TB_MSHOP_PATH.'/settle_kcp.inc.php'); // 환경설정 파일 include
?>
<?php
/* = -------------------------------------------------------------------------- = */
...
$js_return_url = TB_MSHOP_URL.'/orderkcp.php?od_id='.$ordr_idxx;
?>
...
<input type="hidden" name="Ret_URL"      value="<?php echo TB_MSHOP_URL; ?>/kcp/order_approval_form.php">
<!-- 인증시 필요한 파라미터(변경불가)-->
