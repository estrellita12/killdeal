...
if(!$is_member) {
	if($pt_id == 'golfu'){
	   goto_url("https://www.golfu.net/Mobile/Main/Default.aspx?strPrevUrl=https://shopping.golfu.net/m/shop/mypage.php");
	}else {
...
include_once(TB_MTHEME_PATH.'/mypage.skin.php');
