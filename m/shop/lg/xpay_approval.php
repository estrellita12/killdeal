...
$LGD_CLOSEDATE              = date('YmdHis', strtotime("+3 days",TB_SERVER_TIME)); //2021-10-21 유효기한 설정

$LGD_RETURNURL			    = TB_MSHOP_URL.'/lg/returnurl.php';
$LGD_KVPMISPNOTEURL         = TB_MSHOP_URL.'/lg/note_url.php';
$LGD_KVPMISPWAPURL		    = TB_MSHOP_URL.'/lg/mispwapurl.php?LGD_OID='.$LGD_OID;   //ISP 카드 결제시, URL 대신 앱명 입력시, 앱호출함
$LGD_KVPMISPCANCELURL       = TB_MSHOP_URL.'/lg/cancel_url.php';
$LGD_MTRANSFERWAPURL        = TB_MSHOP_URL.'/lg/returnurl.php';
$LGD_MTRANSFERCANCELURL     = TB_MSHOP_URL.'/lg/cancel_url.php';
$LGD_MTRANSFERNOTEURL       = TB_MSHOP_URL.'/lg/note_url.php';
...
$payReqMap['LGD_CLOSEDATE'] = $LGD_CLOSEDATE;               // 가상계좌 NOTEURL
...
$tb['body_script'] = ' onload="launchCrossPlatform();"';
