...
if($_REQUEST['P_STATUS'] != '00') {
    alert('오류 : '.$_REQUEST['P_RMESG1'].' 코드 : '.$_REQUEST['P_STATUS'], $page_return_url);
} else {
    $post_data = array(
...
echo '<input type="hidden" name="P_VACT_NAME"   value="'.$PAY['P_VACT_NAME'].'">'.PHP_EOL;
...
echo '<input type="hidden" name="P_UNAME"       value="'.$PAY['P_UNAME'].'">'.PHP_EOL;
