...
<input type="hidden" name="P_RESERVED"   value="<?php echo get_inicis_app_scheme(); ?>bank_receipt=N&twotrs_isp=Y&block_isp=Y&twotrs_bank=Y<?php echo $useescrow; ?>">
<input type="hidden" name="DEF_RESERVED" value="<?php echo get_inicis_app_scheme(); ?>bank_receipt=N&twotrs_isp=Y&block_isp=Y&twotrs_bank=Y<?php echo $useescrow; ?>">
...
<!-- (2020-12-14) 모바일 가상계좌 기한 3일로 설정 -->
<input type="hidden" name="P_VBANK_DT" value="<?php echo date('Ymd', strtotime("+3 days", TB_SERVER_TIME)); ?>">
<input type="hidden" name="P_VBANK_TM" value="<?php echo date('Hi', strtotime("+3 days", TB_SERVER_TIME)); ?>">
