...
if($w == "")
{
	...
	//20200217 작성 완료 후 이전페이지 이동
	//alert("정상적으로 등록 되었습니다.", $_POST['prev_url']);
    // 2021-06-02
    if( $_POST['prev_url'] == "" ){
        alert("정상적으로 등록 되었습니다.", TB_MSHOP_URL."/view.php?gs_id=$gs_id");
    }else{
        alert("정상적으로 등록 되었습니다.", $_POST['prev_url']);
    }
...
else if($w == "u")
{
	...
	alert("정상적으로 수정 되었습니다", TB_MSHOP_URL."/view.php?gs_id=$gs_id");
}
else if($w == "d")
{
	if(!is_admin())
