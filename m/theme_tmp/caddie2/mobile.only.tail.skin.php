...
?>
	...
	<footer id="ft">
		...
		<dl class="ft_address">
			...
			<dd>이메일 : k.dealhelp@gmail.com</dd>
			<dd><?php echo $config['company_name']; ?> <span class="g_hl"></span> <span class="">대표자 : <?php echo $config['company_owner']; ?></span><!-- <span class="g_hl"></span> 전화 : <?php echo $config['company_tel']; ?> --></dd>
			<dd>주소: <?php echo $config['company_addr']; ?></dd>
			<!-- <dd> <span class="">이메일 : <?php echo $super['email']; ?></span></dd>-->
