    ...
    <form name="flogin" action="<?php echo $login_action_url; ?>" onsubmit="return flogin_submit(this);" method="post">
        ...
        <?php if($pt_id != 'thegolfshow') {
            ...
            <section class="login_fs">
                <p class="mart3"><a href="http://m.golfpang.com/m/join/login.do" class="btn_medium wfull">로그인</a></p>
                <p class="mart3"><a href="http://m.golfpang.com/m/join/join.do" class="btn_medium wfull bx-white">회원가입</a></p>
            </section>
            <?php
