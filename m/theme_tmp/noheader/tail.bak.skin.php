...
?>
	...
	<footer id="ft">
		<ul class="ft_menu">
			...
			<?php } ?>
			<li><a href="<?php echo TB_BBS_URL; ?>/faq.php?faqcate=1">자주묻는질문</a></li>
		...
		<dl class="ft_address">
            ...
            <?php if($pt_id=='admin'){ ?>
			<dd class="tel">전화 : <?php echo $config['company_tel']; ?></dd>
            <?php }else{ ?>
			<dd class="tel">쇼핑 문의 : <?php echo $config['company_tel']; ?></dd>
            <?php } ?>
			...
			<dd>전화 : <?php echo $config['company_tel']; ?> <span class="g_hl"></span> <span class="">이메일 : <?php echo $super['email']; ?></span></dd>
