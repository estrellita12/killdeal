...
<div id="sit_qa_write" class="new_win">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            <th scope="row">*성별</th>
            <td colspan="2"><label class="marr10 "><input type="radio" name="gender" value="M" class="required" required><span class="padl5">남</span></label> <label><input type="radio" name="gender" value="W" required> <span class="padl5" class="required">여</span></label></td>
        </tr>
        <tr>
            <th scope="row">*연령</th>
            <td colspan="2"><label>
        ...
        <tr>
            ...
            <td colspan="2"><label><textarea name="memo" rows="10" required itemname="질문" class="frm_textbox wufll required" minlength="20" ><?php echo $memo; ?></textarea></label></td>
        </tr>
        <tr>
    ...
    <div class="win_btn">
        ...
        <!-- <a href="javascript:location.href='<?php echo $prev_url; ?>';" class="btn_medium bx-white">창닫기</a> -->
        <a href="javascript:history.back();" class="btn_medium bx-white">창닫기</a>
    </div>
    </form>
</div>
