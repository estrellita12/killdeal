...
?>
	...
	<footer id="ft">
		<ul class="ft_menu">
			...
			<?php } ?>
			<li style="width:50%"><a href="<?php echo TB_BBS_URL; ?>/faq.php?faqcate=1">고객센터</a></li>
			<li style="width:50%"><a href="javascript:saupjaonopen('<?php echo conv_number($config['company_saupja_no']); ?>');">사업자정보확인</a></li>
		</ul>
		<!-- <dl class="ft_cs">
			<dt>고객센터 / 계좌안내</dt>
		...
		<dl class="ft_address">
			<dd>쇼핑문의 / 메이저월드 고객센터 070-4938-5588</dd>
			<dd>이츠골프 <?php echo $config['company_tel']; ?> <span class="g_hl"></span> <span class="">대표자 : <?php echo $config['company_owner']; ?></span>  <span class="g_hl"></span> <span class="">이메일 : <?php echo $super['email']; ?></dd>
			<dd>주소: <?php echo $config['company_addr']; ?></dd>
			<dd>통신판매업신고 : <?php echo $config['tongsin_no']; ?></dd>
			<dd>사업자등록번호 : <?php echo $config['company_saupja_no']; ?> <?php echo $config['company_name']; ?>  </dd>
...
$(function() {
	...
	var adheight = $(".top_ad").height() + $("#m_gnb").height();
	$(window).scroll(function () {
