...
<div id="sod_bsk">
    ...
    <ul class="sod_list">
        ...
        <li class="sod_li">
            ...
            <div class="li_prqty">
				...
				<?php echo number_format($sell_amt/$sell_qty); ?></span>
            ...
            <div class="li_total">
				...
				<strong class="price_td<?php echo $i;?>"><?php echo number_format($sell_price); ?></strong></span>
    ...
    <div class="cart_tot_wrap">
        ...
        <h3 class="tot_tit">전체합계</h3>
        <dl id="sod_bsk_tot" class="cart_tot">
            ...
            <?php if($tot_price > 0) { ?>
            <dt><span>적립포인트</span></dt>
            <dd><strong><?php echo number_format($tot_point); ?> P</strong></dd>
            <dt class="sod_bsk_cnt"><span>총 결제금액</span></dt>
            <dd class="sod_bsk_cnt"><strong id="sod_bsk_cnt"><?php echo number_format($tot_price); ?> 원</strong></dd>
            <?php } ?>
        </dl>
    </div>
    <?php } ?>
...
$(document).ready(function(){
    $(".m_checked_wrap .checked_cnt").html(checkedEl + "개");
});
...
$(function() {
    ...
    $("input[name=ct_all]").click(function() {
        if($(this).is(":checked")){
            ...
            $(".m_checked_wrap .checked_cnt").html('0개');
        }
    });
