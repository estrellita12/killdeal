	...
	<?php if(!$is_only) { ?>
		...
		<div class="sp_tbox">
			<ul>
				...
				<li class='trst'>
					<div class='trst-amt tl'><?php echo display_price2(ceil(($gs['goods_price']/0.9)/100)*100); ?></div>
				</li>
			</ul>
    	</div>
		<div class="sp_tbox">
			<ul>
				<li class='tlst'>할인 코드</li>
				<li class='trst'>
					<div ><?php echo trans_pt_name($pt_id) ?> </div>
				</li>
			</ul>
    	</div>
		<div class="sp_tbox">
			<ul>
				<li class='tlst'>최종 할인가격</li>
				<li class='trst'>
