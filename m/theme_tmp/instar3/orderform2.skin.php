		...
		<div class="odf_tbl">
            ...
            <tr>
                <td>
				  ...
				  <?php if($pt_id == 'golf'){ ?>
						<label>
							<input type="text" name="name" value="<?php echo get_session('mem_nm'); ?>" required class="frm_input required" maxlength="20">
						</label>
			...
			<tr>
				...
				<?php if($pt_id == 'golfpang'){ ?>
					<label>
				     <input type="text" name="cellphone" value="<?php echo $_COOKIE['gp_phone']; ?>" onKeyup="PhoneNumberSplit(this);" required class="frm_input required" maxlength="13">
					</label>
				<?php //20191115 더골프쇼 주문폼 정보 자동생성
					  }else if($pt_id == 'thegolfshow'){ ?>
							<label>
				     		<input type="text" name="cellphone" value="<?php echo get_session('ss_mb_phone'); ?>" onKeyup="PhoneNumberSplit(this);" required class="frm_input required" maxlength="13"> 
							</label>
				<?php }else{ ?> 
					<label>
			...
			<tr>
				...
				<?php //20191115 더골프쇼 주문폼 정보 자동생성
					  if($pt_id == 'thegolfshow'){ ?>
						<label><input type="text" name="email" value="<?php echo get_session('ss_mb_email'); ?>" required class="frm_input required"></label>
				<?php }else{ ?> 
