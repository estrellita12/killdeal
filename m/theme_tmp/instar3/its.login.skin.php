...
<div class="mb_login">
	...
	<section class="login_fs">
		<p class="mart10"><button onClick="login_its_member(<?php echo $gs_id[2]; ?>);" class="btn_medium wfull">이츠골프 로그인</button></p>
		</br>
		*이츠골프 회원계정으로 로그인 후<br> 쇼핑진행하시면됩니다. 
		</br>
		</br>
		<p class="mart3"><a class="btn_medium wfull bx-white" onClick="reg_its_member();">회원가입</a></p>
	</section>
