...
<?php } // 인스타그램 ?>
    ...
    <!-- <?php if(basename($_SERVER["PHP_SELF"])!="timesale.php"){ ?>
    <script>
    $(document).ready(function(){
        //2022-01-27 인플루언서 가격 추가 스크립트
        $('.mpr').append('&nbsp;<span style="font-weight: lighter; font-size : 11px; background:black; color:white;"> 10% 추천할인★ &nbsp; </span>');
    });    
    </script>
    <?php } ?> -->
