...
if($w == "") {
    ...
    if(!isset($_POST['agree']) || !$_POST['agree']) {
        alert('회원가입 약관 내용에 동의하셔야 회원가입 하실 수 있습니다.', TB_MBBS_URL.'/register_deal.php');
    }

    if(!isset($_POST['agree2']) || !$_POST['agree2']) {
        alert('개인정보 수집 및 이용 내용에 동의하셔야 회원가입 하실 수 있습니다.', TB_MBBS_URL.'/register_deal.php');
    }
...
$register_action_url = TB_HTTPS_MBBS_URL.'/register_form_update_deal.php';
include_once(TB_MTHEME_PATH.'/register_form_deal.skin.php');
